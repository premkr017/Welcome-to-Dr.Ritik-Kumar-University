...
if (isset($_POST['submit'])) {
    ...
    $checkSql = "SELECT * FROM d_pharm WHERE email = '$email' OR phone = '$phone'";
    ...
    $sql = "INSERT INTO d_pharm ( name, email , phone, gender, dob, password ) 
...
<head>
    ...
    <title>D.Pharma Admission Registration</title>
        ...
        <section class="text-gray-700 body-font bg-gray-100 py-16">
            <div class="container mx-auto px-5">
                ...
                <p class="text-lg text-center max-w-3xl mx-auto text-gray-600 mb-8">
                    The <b>D.Pharma program</b> at Dr. Ritik Kumar University is a 2-year diploma course
                    designed to provide foundational knowledge of pharmaceutical science, drug formulation,
                    pharmacology, and pharmacy practice. This course prepares students for roles in hospitals,
                    medical stores, and pharmaceutical companies.
                </p>
                ...
                <div class="grid md:grid-cols-3 gap-6 mt-10">
                    ...
                    <div class="bg-white shadow-md p-6 rounded-lg">
                        ...
                        <p class="text-gray-600">Passed 10+2 with PCB/PCM (Science Stream).</p>
                    </div>
                    ...
                    <div class="bg-white shadow-md p-6 rounded-lg">
                        ...
                        <ul class="list-disc pl-4 text-gray-600">
                            ...
                            <li>Pharma Sales Executive</li>
                            <li>Drug Distribution Assistant</li>
                        </ul>
                    </div>
                </div>
            </div>
