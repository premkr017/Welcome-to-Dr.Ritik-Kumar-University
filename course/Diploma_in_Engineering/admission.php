...
<head>
    ...
    <title>Diploma In Engineering Admission Registration</title>
        ...
        <section class="text-gray-700 body-font bg-gray-100 py-16">
            <div class="container mx-auto px-5">
                ...
                <p class="text-lg text-center max-w-3xl mx-auto text-gray-600 mb-8">
                    The <b>Diploma in Engineering</b> program focuses on practical and technical knowledge required
                    for various engineering fields. This 3-year course helps students build strong fundamentals
                    for careers in industries, workshops, manufacturing, IT, electronics, civil engineering,
                ...
                <div class="grid md:grid-cols-3 gap-6 mt-10">
                    ...
                    <div class="bg-white shadow-md p-6 rounded-lg">
                        ...
                        <p class="text-gray-600">Passed 10th (Matric) with minimum 35% marks.</p>
                    </div>
