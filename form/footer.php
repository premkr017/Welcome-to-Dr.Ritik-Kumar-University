...
<footer class="bg-gray-900 text-gray-300 mt-10">
  <div class="container mx-auto py-10 px-4 grid grid-cols-1 md:grid-cols-3 gap-8">
    ...
    <div>
      ...
      <ul class="space-y-2">
        ...
        <li><a href="course.php" class="hover:text-blue-400">Courses</a></li>
        <li><a href="admission.php" class="hover:text-blue-400">Admissions</a></li>
