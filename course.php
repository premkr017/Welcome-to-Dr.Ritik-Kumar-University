...
<main class="bg-gray-100 min-h-screen py-10">
  ...
  <div class="text-center mb-10">
    <h1 class="text-4xl font-bold text-blue-700">Our Popular Courses</h1>
    <p class="text-gray-600 mt-2">Choose from a variety of programs to build your future</p>
  </div>
  ...
  <div class="container mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 px-4">
    ...
    <div class="bg-white shadow-lg rounded-xl p-6 hover:shadow-2xl transition">
      ...
      <a href="./course/bca/admission.php" class="block text-center bg-blue-700 text-white py-2 rounded-lg hover:bg-blue-800 transition">View Details</a>
    </div>
    ...
    <div class="bg-white shadow-lg rounded-xl p-6 hover:shadow-2xl transition">
      ...
      <a href="./course/B_Sc/admission.php" class="block text-center bg-blue-700 text-white py-2 rounded-lg hover:bg-blue-800 transition">View Details</a>
    </div>
